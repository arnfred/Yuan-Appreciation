...
There are incentives for a national bank to maintain a \emph{low} exchange rate, i.e. to keep its currency at a low value. Take a typical tradable good as an example: A watch produced in Switzerland sells at a fixed price in Swiss Francs (CHF). If for one euro you get 1.50 CHF exchanges for 0.7 Euro, a watch worth 1000 CHF costs 666 Euro in Germany. If the value of the Swiss Franc rises, so that one CHF exchanges for exactly one euro, the price of the same watch is now 1000 euro in Germany - it is now a much less competitive good on the world markeet.

Since manipulating the exchange rate can be beneficial for a nation’s exports and foreign investments, National Banks often might tempted to promote their country’s exports by holding the exchange rate low. 
...
China's exchange rate policy has been criticized for keeping the Chinese currency, the renminbi (RMB) undervalued. Such criticism is based on an argument of the following structure: First
...
\item{China imposes foreign exchange controls that limits the amount of RMB that is sold international investors or other governments.}%this seems clear, but i have not yet found how they do it exactly
\end{enumerate}
...
practice of \emph{sterilization}. If the Chinese government buys foreign 
...
to inflation.\footnote{TODO: Maybe quickly explain the assumed mechanism?} As 
...
http://www.clevelandfed.org/research/trends/2010/1110/01intmar.cfm}%TODO: 
...
http://www.clevelandfed.org/research/trends/2010/1110/01intmar.cfm}%display 
data?
...
%fmolo: I integrated this in the following paragraphs.
